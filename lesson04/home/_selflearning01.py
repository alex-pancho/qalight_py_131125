...
substring_3_to_8 = text[2:8]  # Ваш код тут text[3:8]
...
every_second_char = text[0:13:2]  # Ваш код тут text[::2]
...
# 1.1: "H"
# 1.2: "!"
# 1.3: "o" - Щоб отримати "о" - потрібно зробити - text[4]
# 1.4: "d"
# 1.5: "lo, W" - Щоб отримати "lo, W", потрібно взяти символи з індекса 3 по 7 включно.
# 1.6: "Hello"
# 1.7: "World!"
# 1.8: "Hlo ol!"
# 1.9: "!dlroW ,olleH"
# 1.10: "elo r" - не можливо зробити при такому завданні